...
public class RPGStoryGame {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Scanner menuSaveAction = new Scanner(System.in);
        ...
        if (menuSaveAction.equals("yes")) {
            ...
            try {
                ...
                System.out.println("You have an existing saved file");
            }
        ...
        while (play && lifeCount > -1) {
            ...
            //if (pastRecords.canExecute() && pastRecords.canRead()) {
            if (!pastRecords.exists()) {    
                
                System.out.println("No prevous save files found.\nDo you want to "
                        + "create a save file right now?(yes) or (no)\nYou may create "
                        + "only one new save file and update your progress at check points in the story.");
                ...
                String saveNamePrint;
                //String pastName = pastRecords.nextLine();
                //name = pastName.substring(6, 15);
                name = pastRecordNameReader.next();
                    saveNamePrint = name.substring(5);
                    name = saveNamePrint;
